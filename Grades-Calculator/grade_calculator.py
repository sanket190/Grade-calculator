...
class GradeCalculator:
    ...
    def add_category(self, category_name: str, percentage_of_grade: str) -> None:
        ...
        if not self._is_possible_grade_less_than_or_equal_100():
            ...
            raise ValueError \
                (f'GradeCalculator.add_category: Percentage {percentage_of_grade}% of category {category_name} would make the total possible percentage {total_percentage_too_long}%, which exceeds the possible 100%')
    ...
    def add_assignment(self, category_name: str, assignment_name: str, score: str) -> None:
        ...
        try:
            ...
            raise AssertionError \
                ('GradeCalculator.add_assignment: Given earned score and possible score must be of type int or float')
